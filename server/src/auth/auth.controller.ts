...
export class AuthController {
    ...
    @ApiResponse({ status: 400, type: Response, description: 'Not all fields provided or incorrect username | password'})
    ...
    @ApiResponse({ status: 200, type: ILoginResponse })
    @ApiResponse({ status: 400, type: Response, description: 'Not all fields provided or username taken'})
    @ApiResponse({ status: 500, type: Response, description: 'Server error'})
    @Post('/register')
