...
import {DeleteBy} from "../comments/types/comment.types";
...
export class TasksService {
    ...
    async deleteTask(req) {
        ...
        await this.commentService.deleteAllComments({type: DeleteBy.taskId, id: req.params.id});
        await this.taskModel.findByIdAndRemove(req.params.id);
    ...
    async deleteAllTasks(boardId: string) {
        await this.commentService.deleteAllComments({type: DeleteBy.boardId, id: boardId});
